...
class Product(models.Model):
    ...
    image = VersatileImageField('image',upload_to='images/product',ppoi_field='image_ppoi')
    is_enabled = models.BooleanField(default=True)
    image_ppoi = PPOIField()


class product_image(models.Model):
    product = models.ForeignKey(Product, null=True,related_name='image_product', blank=True, on_delete=models.CASCADE)
    image = models.FileField(upload_to='images/category', default=None)
